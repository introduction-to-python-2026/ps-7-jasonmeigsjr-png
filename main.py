...
selected_features = ['sepallength', 'sepalwidth', 'petallength', 'petalwidth', 'class']
...
reference_feature = selected_features[0] #you can specify by name or select item from the list, e.g. selected_features[1]
